	...
	return (
		<div className="bg-bg-primary text-text-default pt-8 pb-12 flex justify-center">
			<div className="px-3 max-w-[1248px]">
				...
				<div>
					<h1 className="text-[32px] md:text-[40px] font-extrabold">
						NetClone {t("termsOfUse")}
					</h1>
					...
					<ol className="list-decimal pl-4">
						<li className="mt-8">
							<p>
								...
								<br />
								<br />
								<span>{t("membership.1.1")}</span>
								<br />
								<br />
								<span>{t("membership.1.2")}</span>
							</p>
						</li>
						<li className="mt-8">
							<p>
						...
						<li className="mt-8">
							<p>
								...
								<span className="underline">
									{t("billingAndCancellation.3.1.title")}.
								</span>{" "}
								...
								3.2.{" "}
								<span className="underline">
									{t("billingAndCancellation.3.2.title")}.
								</span>{" "}
								...
								3.3.{" "}
								<span className="underline">
									{t("billingAndCancellation.3.3.title")}.
								</span>{" "}
								...
								3.4.{" "}
								<span className="underline">
									{t("billingAndCancellation.3.4.title")}.
								</span>{" "}
								...
								3.5.{" "}
								<span className="underline">
									{t("billingAndCancellation.3.5.title")}.
								</span>{" "}
