...
const PrivacyPage = () => {
	...
	const handleIntersection = (
		...
		const currentEntryIndex = refs.current.findIndex(
			(el) => el.id === currentEntryId
		);
		const activeSectionIndex = refs.current.findIndex(
			(el) => el.id === activeRef.current
		);
			...
			<div className="px-3 max-w-[1248px]">
				...
				<div className="relative">
					...
					<div className="flex flex-col ml-auto md:max-w-[70%]">
						...
						<section
							ref={addToSectionRefs}
							id="section-a-dropdown"
							className="flex flex-col gap-10"
						>
							<h2 className={`text-3xl mt-20 `} id="section-a" ref={addToRefs}>
								{t("sectionA")}
							</h2>
							<TheCategoriesOfPersonal
								ref={addToRefs}
								id="the-categories-of-personal-information-we-collect"
							/>
							<WhereWeCollectPersonal
								ref={addToRefs}
						...
						<section
							ref={addToSectionRefs}
							id="section-b-dropdown"
							className="flex flex-col gap-10"
						>
							<h2 className={`text-3xl mt-20`} id="section-b" ref={addToRefs}>
								{t("sectionB")}
							</h2>
							<YourPrivacyRights ref={addToRefs} id="your-privacy-rights" />
							<ComunicationAndMarketing
								ref={addToRefs}
